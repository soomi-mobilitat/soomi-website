...
const MunicipalServices = () => {
  ...
  return (
    <section id="services" className="page-section py-24 bg-white dark:bg-gray-900">
      <div className="container">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20 animate-on-scroll">
          ...
          <h3 className="text-xl text-gray-700 dark:text-gray-300 font-medium mb-6">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a
              ...
              className="px-6 py-3 border border-gray-800 dark:border-gray-300 text-gray-800 dark:text-gray-100 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer"
            >
